            ...
            <div className="footer_col">
              <div className="flex flex-col gap-8">
                ...
                <div className="flex gap-4 mt-2">
                  <a href="https://www.linkedin.com/company/tattvira-private-limmited/" target="_blank" rel="noopener noreferrer" className="footer_links block" aria-label="LinkedIn">
